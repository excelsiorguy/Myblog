 ...
 * @param config
 */
const request = async (url: string, options: IOption, config?: AxiosRequestConfig): Promise<any> =>
 ...
 * @param config
 */
export const get = (url: string, param?: Record<string, unknown>, config?: AxiosRequestConfig): Promise<any> =>
 ...
 * @param config
 */
export const post = (url: string, param?: Record<string, unknown>, config?: AxiosRequestConfig): Promise<any> =>
 ...
 * @param config
 */
export const put = (url: string, param?: Record<string, unknown>, config?: AxiosRequestConfig): Promise<any> =>
 ...
 * @param config
 */
export const del = (url: string, param?: Record<string, unknown>, config?: AxiosRequestConfig): Promise<any> =>
